...
for k in kind:
    ...
    with open(os.path.join(tmp_dir, target_name)) as f0:
    ...
    with open(os.path.join(tmp_dir, source_name)) as f1:
    ...
    with tf.python_io.TFRecordWriter('./cnn_tfrecord/google/' + k + '.tfrecord') as writer:
        ...
        for s, t in zip(sources, targets):
            ...
            example = tf.train.Example(features=tf.train.Features(feature={
                ...
                'input_mask': tf.train.Feature(int64_list=tf.train.Int64List(value=s_mask)),
